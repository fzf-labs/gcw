...
**Single context (most repos):** One project glossary at the repo root.

**Multiple contexts:** A root context map lists the contexts, where they live, and how they relate to each other:
...
- If neither exists, create a root glossary lazily when the first term is resolved
