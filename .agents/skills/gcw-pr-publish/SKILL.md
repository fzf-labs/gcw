...
- Pushed issue branch.
- Readiness evidence and current planning/progress links.
- GitHub or GitLab repository context.

## Procedure

1. Confirm readiness evidence passes.
...
4. Update GCW progress with the review request URL.
...
- Stop in `implementing` if readiness evidence is incomplete and implementation work must continue.
